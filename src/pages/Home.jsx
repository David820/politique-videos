...
import imLeft from "../assets/img/vidleft.webp";
import imRight from "../assets/img/vidright.webp";

const Home = () => 

    <div>

        <section className={css`margin-top:56px;`}>
        ...
        <section>
            ...
            <div className={css`display:flex;justify-content:space-between;align-items:center;margin:32px 0;
                @media (width <= 1200px) {display:none;}
            `}>
                <img src={imLeft} width={540} />
                <img src={imRight} width={540} />
            </div>
